import { Bike, Check, CircleCheckBig, Earth, Network, Wrench, X } from 'lucide-react';
...
const Dashboard = () => {
    ...
    const { totalDocs:p } = useContext(ProductContext) as ProductContextType;
    const { state: a } = useContext(AccessoryContext) as AccessoryContextType;
        ...
        <div>
            ...
            <div className="grid grid-cols-3 gap-3 ">
                <div className="rounded-lg  bg-white py-10 p-10 transition-transform transform hover:shadow-xl">
                    ...
                    <div className='flex justify-between items-center mt-7'>
                        <p className="text-[16px] font-medium">Tổng đơn hàng chưa xác nhận</p>
                        <h4 className="text-title-md font-bold text-[#1c2434]">
                            {orderStatus0}
                        </h4>
                    </div>
