    ...
    <form onSubmit={handleSubmit(onSubmit)}>
        ...
        {previewImg.map((img, index) => (
          <div key={index} className="relative mb-10 hover:shadow-2xl">
            <img
              ...
              className="w-[390px] bg-white  p-6  rounded-lg"
            />
            <button
              type="button"
              onClick={(e) => {
      ...
      <div className="bg-white p-6 space-y-6 shadow-lg">
        <div
          ...
          className="w-full text-gray-600 flex flex-col items-center justify-center cursor-pointer border-2 hover:border-[#ef4d38] rounded-lg border-dashed p-2"
        >
        ...
        <div className="flex justify-between mt-4">
          <Link to="/admin/banner">
            <button
              type="button"
              className="custom-button rounded-lg h-12 w-30"
            >
              <MoveLeft />
            </button>
          </Link>
